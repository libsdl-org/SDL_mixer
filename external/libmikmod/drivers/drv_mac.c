...
#pragma unused(channel)
	...
	if (Player_Paused_internal())
		written=VC_SilenceBytes((SBYTE*)doubleBuffer->dbSoundData,(ULONG)SOUND_BUFFER_SIZE);
	else	written=VC_WriteBytes((SBYTE*)doubleBuffer->dbSoundData,(ULONG)SOUND_BUFFER_SIZE);
	MUTEX_UNLOCK(vars);
