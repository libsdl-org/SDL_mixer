...
_sym_mangle synth_1to1_s32_s_sse_asm
...
SECTION .text
align 16
GLOBAL synth_1to1_s32_s_sse_asm
...
Loop_start_1:
	...
	movaps	xmm3, xmm0
	movaps	xmm4, xmm0
	mulps	xmm5, [scale_s32]
	mulps	xmm0, [scale_s32]
	cmpnleps	xmm1, [maxmin_s32]
	cmpltps	xmm2, [maxmin_s32+16]
	cmpnleps	xmm3, [maxmin_s32]
	cmpltps	xmm4, [maxmin_s32+16]
	cvtps2pi	mm0, xmm5
	cvtps2pi	mm1, xmm0
	cvtps2pi	mm2, xmm1
	cvtps2pi	mm3, xmm3
